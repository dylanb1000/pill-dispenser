...
public class Machine implements Runnable {
	...
	// limit switch top
	private GpioPinDigitalInput input1 = gpio.provisionDigitalInputPin(RaspiPin.GPIO_02, 
            PinPullResistance.PULL_UP);
	// limit switch bottom
	private GpioPinDigitalInput input2 = gpio.provisionDigitalInputPin(RaspiPin.GPIO_02, 
            PinPullResistance.PULL_UP);
	//0.1 milliseconds
	...
	public void rotateSlots(int slotNumber) {
		...
		motor.step((1/difference)*this.stepsForRotation);
