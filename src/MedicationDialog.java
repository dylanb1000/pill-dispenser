		    		...
		    		if(checkSlotRange(Integer.parseInt(slot.getText()))==false){
			    		if(checkName(name.getText())==false) {
				    		if(checkSlot(Integer.parseInt(slot.getText()))==false) {
				    			...
				    			LocalTime time=LocalTime.of((Integer)hour.getSelectionModel().getSelectedItem(), (Integer)min.getSelectionModel().getSelectedItem());
				    			int dispenseRate=Integer.parseInt(rate.getText());
				    			model.getUser().getMedicationList().add(new Medication(name,count,slotnumber,time,dispenseRate));
		    	...
		    	try {
		    		if(checkSlotRange(Integer.parseInt(slot.getText()))==false){
			    		if(checkName(name.getText())==false || med.getName().equals(name.getText())) {
				    		if(checkSlot(Integer.parseInt(slot.getText()))==false || med.getSlotNumber()==Integer.parseInt(slot.getText())) {
				    			String name=this.name.getText();
				    			int count=Integer.parseInt(this.count.getText());
				    			int slotnumber=Integer.parseInt(slot.getText());
				    			LocalTime time=LocalTime.of((Integer)hour.getSelectionModel().getSelectedItem(), (Integer)min.getSelectionModel().getSelectedItem());
				    			int dispenseRate=Integer.parseInt(rate.getText());
				    			model.getUser().getMedicationList().set(selectedIndex,new Medication(name,count,slotnumber,time,dispenseRate));
